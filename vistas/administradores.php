...
<body>
    ...
    $datos = $administrador->getAdministrador();
            ...
            <tbody>
                <?php foreach ($datos as $item) { ?>
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#ModalAdministrador<?php echo $item["id"]; ?>">
