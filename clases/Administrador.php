...
class Administrador extends Conexion{
    ...
    //obteniendo todos los administradore
    ...
    public function getAdministradorById(){
        if(isset($_POST['id_administrador'])){
            ...
            $this->conectar();
            $query = "SELECT administrador.*, departamento.nombre AS departamento 
            FROM administrador INNER JOIN departamento 
            ON administrador.id_departamento = departamento.id WHERE administrador.id = $this->id";
            $result = mysqli_query($this->conexion, $query);
            return $result; //[]
        }
    ...
    //actualizando el admi
    public function actualizar(){
        if(isset($_POST['nombre'], $_POST['apellido'], $_POST['salario'], $_POST['carnet'], $_POST
        ['telefono'], $_POST['correo'], $_POST['password'], $_POST['departamento'], $_POST['id_administrador'])){
    ...
    //actualizando el estado del admi en inactivo
